...
from ...serialization.compression_utils import CompressionUtils, CompressionType

if TYPE_CHECKING:
    from ..managers.osm_data_manager_v2 import OSMDataV2
...
class CacheSerializerV2:
    ...
    def save_cache(
        self,
        osm_data,  # OSMDataV2 type annotation removed to avoid circular import
        ...
        try:
            ...
            metadata = CacheMetadataV2.create_from_sources(
    ...
    def load_cache(
        ...
        Returns:
            OSMDataV2 or None: Loaded data or None if failed
        """
        ...
        try:
            ...
            metadata = CacheMetadataV2.load_from_file(self.metadata_file)
            if not metadata:
    ...
    def _reconstruct_osm_data(self, cache_data: Dict):
        """Reconstruct OSMDataV2 from cached data."""
    ...
    def get_cache_info(self) -> Optional[CacheMetadataV2]:
        """Get information about the current cache."""
        return CacheMetadataV2.load_from_file(self.metadata_file)
