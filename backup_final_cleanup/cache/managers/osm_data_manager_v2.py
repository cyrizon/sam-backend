...
from ..serialization.cache_serializer_v2 import CacheSerializerV2
from ..serialization.cache_metadata_v2 import CacheMetadataV2
...
class OSMDataManagerV2:
    ...
    def __init__(self, cache_dir: str = "osm_cache_v2"):
        ...
        self._data: Optional[OSMDataV2] = None
        self._initialized = False
        
        # Composants
        self.cache_serializer = CacheSerializerV2(cache_dir)
